...
import { getAllCloudBackups, getAllCloudBackupsByDate } from "../api";
import { useNavigate } from "react-router-dom";

import { deleteCloudBackups } from "../api";
import { FaTrash } from "react-icons/fa";
import toast, { Toaster } from "react-hot-toast";

import "react-datepicker/dist/react-datepicker.css";

export default function BKCloudView() {
  ...
  const filterBackup = () => {
    ...
    if (searchTerm) {
      filtered = filtered.filter((tape) =>
        tape.cloudName.toLowerCase().includes(searchTerm.toLowerCase())
      );
    }
    console.log("cloud_name", filtered);
                    ...
                    >
                        ...
                        <div>
                          <button
                            ...
                            onClick={async () => {
                              ...
                              if (accepted) {
                                await deleteCloudBackups(item.id);
                      ...
                      <td className="px-6 py-4 text-right">
                        <div
                          ...
                          onClick={() =>
                            handleNavigation(`/detailedCloudBackup/${item.id}`)
                          }
                        >
                          Ver más
                        </div>
