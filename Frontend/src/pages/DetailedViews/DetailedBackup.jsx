...
export default function DetailedBackup() {
  const { id } = useParams();
  ...
  const [tapeConcecutive, setConcecutive] = useState("");
  ...
  useEffect(() => {
    async function loadBackup() {
      if (id) {
        ...
        const { data } = response;
        setConcecutive(data.tape_Concecutive);
                ...
                >
                  ...
                  <tbody className="bg-white text-gray-700">
                    <tr className="hover:bg-gray-50">
                      ...
                      <td className="px-6 py-4 text-center">{item.security}</td>
              ...
              <form className="w-full h-full" onSubmit={handleSubmit}>
                <div className="flex flex-col flex-1 w-full items-center justify-center">
                  <div className="relative w-[90%] mt-10 mx-auto">
                    ...
                    <label className="absolute top-0 left-0 px-2 py-1 mb-3 text-black -translate-y-1/2 transform origin-left scale-75 pointer-events-none transition-all duration-300 ease-in-out font-semibold text-xl uppercase ">
                      Elige la cinta donde deseas realizar el backup ( Opción
                      seleccionada:
                      <span className="text-blue-800"> {tapeConcecutive}</span>)
                    </label>
                  </div>
                  <div className="relative w-[90%] mt-10 mx-auto">
                    <select
                ...
                <div className="flex flex-col flex-1 w-full items-center justify-center ">
                  <div className="relative w-[90%] mt-10 mx-auto">
                    ...
                    <label className="absolute top-0 left-0 px-2 py-1 mb-3 text-black -translate-y-1/2 transform origin-left scale-75 pointer-events-none transition-all duration-300 ease-in-out font-semibold text-xl uppercase ">
                      Seguridad( Dato actual:
                      <span className="text-blue-800"> {data.security}</span>)
                    </label>
                  </div>
                  <div className="relative w-[90%] mt-10 mx-auto">
                    <select
